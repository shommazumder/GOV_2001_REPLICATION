...
setwd('~/Google Drive (Harvard)/GOV_2001_REPLICATION/01_Data/REPLICATION_APSR_2014_BRQ/')
...
tab2.1.leverage <- plot(tab2.1, labels.id = tab2_3.dat$country, 5) ## South Africa, Angola, Algeria super influential
...
tab4.1.scale.location <- plot(tab4.1, 3) ## Is this art??
