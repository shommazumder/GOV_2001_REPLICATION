...
sourceCpp("~/Google Drive/GOV_2001_REPLICATION/02_Analysis/ConleySEs/ConleySE.cpp")
...
ConleySEs <- function(reg,
    ...
    source("~/Google Drive/GOV_2001_REPLICATION/02_Analysis/ConleySEs/IterateObs_Fn.R", local = TRUE)
